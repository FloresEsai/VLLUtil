...
namespace VLLUtility
{
    public partial class MainForm : Form
    {
        ...
        {
            InitializeForm();
            connectionString = ConfigurationManager.ConnectionStrings["VLLDatabase"].ConnectionString;
            TestSqlConnection();
            SetBackgroundImage();
        }
        ...
        private void SetBackgroundImage()
        {
            ...
            string imagePath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources\\Terralogic Logo (New 2019).png");

            // Set the image as the background
            this.BackgroundImage = Image.FromFile(imagePath);
            this.BackgroundImageLayout = ImageLayout.Center; // Options: None, Tile, Center, Stretch, Zoom
        }
        ...
        {
            this.btnAdd = CreateButton("Add", new System.Drawing.Point(20, 500), AddButton_Click);
            this.btnUpdate = CreateButton("Update", new System.Drawing.Point(120, 500), UpdateButton_Click);
            this.btnDelete = CreateButton("Delete", new System.Drawing.Point(220, 500), DeleteButton_Click);
        ...
        {
            // Arrange TextBoxes in a single column with labels for alignment
            this.txtField1 = CreateTextBox(new System.Drawing.Point(150, 280));
            this.txtField2 = CreateTextBox(new System.Drawing.Point(150, 320));
            this.txtField3 = CreateTextBox(new System.Drawing.Point(150, 360));
            this.txtField4 = CreateTextBox(new System.Drawing.Point(150, 400));
            this.txtField5 = CreateTextBox(new System.Drawing.Point(150, 440));
            this.txtField6 = CreateTextBox(new System.Drawing.Point(150, 480));
        ...
        {
            // Arrange labels vertically to the left of their corresponding input fields
            ...
            this.lblOwnerAddr = CreateLabel("Owner Address | AD Account:", new System.Drawing.Point(20, 400));
            this.lblFullName = CreateLabel("Full Name | Title:", new System.Drawing.Point(20, 440));
            this.lblOwnerLoc = CreateLabel("Owner Location:", new System.Drawing.Point(20, 480));
        ...
        private async void UpdateListViewForSelectedTable(string tableName)
        {
            ...
            // Wait before loading data just the first time
            if (!isDataLoaded)
            {
